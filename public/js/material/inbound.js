...
define(function (require) {
    ...
    var inboundTpl = require('tpl/material/inbound.tpl');
    ...
    var main = {
        ...
        bindEvent: function () {
            ...
            $('.select2').select2();
            totalPriceMain.init();
            $('body').on('change','#materialstockinfo-materialname',function(e){
                    var val = $(this).val();
                    _self.addRecipe(val);
                    $(this).val('');
            });
            $('body').on('click','.material-stock-info .op-group>img',function(){
                    $(this).parents('tr').hide();
                    $(this).siblings('input[name="MaterialStockInfo[deleted][]"]').val(1);
        ...
        addRecipe : function(id){
            ...
            $('.material-stock-info tbody').append(inboundModel);
