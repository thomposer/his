...
<div class="dental-first-template-form col-md-8">
    ...
    <?= $form->field($model, 'chiefcomplaint')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'historypresent')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'pasthistory')->textarea(['rows' => 6]) ?>
    ...
    <div class="form-group">
        <?= Html::a('取消',['dentalfirst-index'],['class' => 'btn btn-cancel btn-form second-cancel']) ?>
