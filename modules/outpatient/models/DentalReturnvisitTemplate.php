...
/**
 * This is the model class for table "{{%dental_returnvisit_template}}".
 *
 * @property integer $id
 ...
 */
class DentalReturnvisitTemplate extends \app\common\base\BaseActiveRecord
{
    public $username;
    ...
    {
        return '{{%dental_returnvisit_template}}';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['spot_id', 'create_time', 'update_time','user_id','type'], 'integer'],
            [['returnvisit', 'oral_check', 'auxiliary_check', 'diagnosis', 'cure_plan', 'cure', 'advice', 'remark'], 'string','max' => 1000],
            [['returnvisit', 'oral_check', 'auxiliary_check', 'diagnosis', 'cure_plan', 'cure', 'advice', 'remark'], 'default','value' => ''],
            [['name'], 'string', 'max' => 64],
            [['name'],'validateName'],
            [['name'],'trim']
        ];
    ...
    public static function setModel($model, $case_id, &$dentalHistoryRelation) {
        ...
        $model->returnvisit = $caseInfo['returnvisit'];
