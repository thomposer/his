...
/**
 * This is the model class for table "{{%cure_template}}".
 *
 * @property string $id
 ...
 *
 * @property CureTemplateInfo[] $cureTemplateInfos
 */
class CureTemplate extends \app\common\base\BaseActiveRecord
{
     ...
     */
    public static function findCureTemplateModel($id) {
    ...
    /**
     * @return 治疗医嘱模板树形结构menu
     */
    public static function getCureTemplateMenu() {
        $query = new Query();
        ...
        $query->orderBy(['a.type' => SORT_DESC, 'a.template_type_id' => SORT_DESC, 'a.id' => SORT_ASC]);
        $result = $query->all();
        return $result;
    }
