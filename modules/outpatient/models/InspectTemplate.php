...
/**
 * This is the model class for table "{{%inspect_template}}".
 *
 * @property string $id
 ...
 *
 * @property InspectTemplateInfo[] $inspectTemplateInfos
 */
class InspectTemplate extends \app\common\base\BaseActiveRecord
{
     ...
     */
    public function getInspectTemplateInfos() {
        return $this->hasMany(InspectTemplateInfo::className(), ['inspect_template_id' => 'id']);
    }
     ...
     */
    public static function findInspectTemplateModel($id) {
     ...
     */
    public static function getInspectTemplateMenu() {
        $query = new Query();
