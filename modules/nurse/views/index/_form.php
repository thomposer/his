...
<div class="patient-form">
    ...
    <div class = 'row title_child_div'>
        <div class = 'col-sm-12'>
            <p class="title_p">
                <span class="circle_span"></span>
                <span class="title_span">接诊信息</span>
            </p>
        </div>
    </div>
    <div class = 'row'>
        ...
        <div class = 'col-sm-4'>
              <?= $form->field($model->getModel('triageInfo'), 'room_id')->dropDownList(ArrayHelper::map($room, 'room_id', 'room_name'),['prompt' => '请选择'])->label('接诊诊室<span class = "label-required">*</span>') ?>
        </div>
        <div class = 'col-sm-4'>
            <?= $form->field($model->getModel('report'), 'type_description')->textInput(['value' => '方便门诊','disabled' => true])->label($reportModelAttributeLabels['type_description'].'<span class = "label-required">*</span>') ?>
        </div>
        
    </div>
    <div class = 'row'>
    	<div class = 'col-sm-4'>
        <?= $form->field($model->getModel('report'), 'second_department_id')->dropDownList([],['prompt' => '请选择'])->label($reportModelAttributeLabels['second_department_id'].'<span class = "label-required">*</span>') ?>
        </div>
        <div class = 'col-sm-4'>
            	<div class = 'show-hide-btn-nurse btn'>展开更多   <i class="fa fa-angle-down" aria-hidden="true"></i></div>
        </div>
    </div>
    <div class = 'other-info'>
   	<div class = 'row title_child_div'>
        <div class = 'col-sm-12'>
            <p class="title_p">
                <span class="circle_span"></span>
                <span class="title_span">更多信息</span>
            </p>
        </div>
    </div>
    <div class = 'row'>
    ...
    <div class="form-group">
        ...
        <?= Html::submitButton('保存', ['class' => 'btn btn-default btn-form','id' => 'reportForm']) ?>
    </div>
