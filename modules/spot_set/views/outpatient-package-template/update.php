...
<div class="once-department-update col-xs-10">
    <div class = "box">
    <div class="box-header with-border">
      <span class = 'left-title'><?= Html::encode($this->title) ?></span>
      <?=  Html::a(Html::img($baseUrl.'/public/img/common/icon_back.png').'返回',['@spot_setOutpatientPackageTemplatePackageTemplateIndex'],['class' => 'right-cancel second-cancel']) ?>      
    </div>
        <div class = "box-body">
