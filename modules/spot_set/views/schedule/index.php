...
/* @var $searchModel app\modules\spot_set\models\search\ScheduleSearch */
...
<div class="schedule-index col-xs-12">
...
//            ['class' => 'yii\grid\SerialColumn'],
            ...
            [
                ...
                'headerOptions'=>['class'=>'col-xs-5 col-sm-5 col-md-5'],
            ],
            [
                'attribute' => 'status',
                'value' => function ($searchModel){
                    return Schedule::$getStatus[$searchModel->status];
                }
            ],
