...
$this->params['breadcrumbs'][] = ['label' => '医疗耗材管理', 'url' => ['consumables-inbound-index']];
...
<div class="stock-form col-xs-10">
    ...
    <div class="box-header with-border">
      ...
      <?=  Html::a(Html::img($baseUrl.'/public/img/common/icon_back.png').'返回',['consumables-inbound-index'],['class' => 'right-cancel']) ?>      
    </div>
    <div class = "box-body"> 
    ...
    <div class = 'margin-bottom margin-top'>
        <div class = 'row'>
            ...
            <div class = 'col-xs-4 col-sm-4 col-md-4'>
                入库方式：<?= ConsumablesStock::$getInboundType[$model->inbound_type] ?>
            </div>
        </div>
        <div class = 'row'>
            <div class = 'col-xs-4 col-sm-4 col-md-4'>
    ...
    <div class="form-group">
        <?= Html::a('审核通过',['@stockIndexConsumablesInboundApply','id' => $id,'status' => 1],[
        ...
        <?= Html::a('审核不通过',['@stockIndexConsumablesInboundApply','id' => $id,'status' => 3],
            [
                'class' => 'btn btn-default btn-form',
                'data-method' => false,
                'aria-label' => '审核不通过',
        ...
        <?= Html::a('取消',['consumables-inbound-index'],['class' => 'btn btn-cancel btn-form']) ?>
    </div>
    <?php endif;?>
</div>
</div>
