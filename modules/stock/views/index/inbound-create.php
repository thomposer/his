...
<div class="stock-create col-xs-10">
    ...
    <div class="box-header with-border">
      ...
      <?=  Html::a(Html::img($baseUrl.'/public/img/common/icon_back.png').'返回',['consumables-inbound-index'],['class' => 'right-cancel second-cancel']) ?>      
    </div>
        <div class = "box-body">    
...
<?php  $this->beginBlock('renderJs')?>
   <script type="text/javascript">
 		var baseUrl = '<?= $baseUrl ?>';
 		var inboundIndexUrl = '<?= Url::to(['@stockIndexConsumablesInboundIndex']); ?>';
 		var consumablesList = <?= json_encode($consumablesList,true); ?>;
 		var typeList = <?= json_encode(Consumables::$typeOption,true) ?>;
        var view=0;//增加或者编辑入口
		require(["<?= $baseUrl ?>"+"/public/js/stock/inbound.js"],function(main){
			main.init();
		});
