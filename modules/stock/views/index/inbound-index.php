    ...
    <?= GridView::widget([ 
        ...
        'columns' => [
            ...
            [
                'attribute' => 'status',
                'value' => function ($searchModel){
                   return ConsumablesStock::$getStatus[$searchModel->status];
                }
            ],
            [ 
                'class' => 'app\common\component\ActionTextColumn',
                'template' => '{consumables-inbound-update}{consumables-inbound-delete}{consumables-inbound-apply}{consumables-inbound-view}',
