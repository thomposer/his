...
<div class="stock-form col-md-12">
    ...
    <div class = 'box'>
        <?= $form->field($model->getModel('outboundInfo'), 'materialName')->dropDownList(ArrayHelper::map($materialList, 'id', 'name'),['prompt' => '请选择','class' => 'form-control select2','style' => 'width:100%'])->label(false) ?>
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($dataProvider) {
                        return Html::input('text', 'MaterialOutboundInfo[num][]', $dataProvider->num, ['class' => 'form-control']);
                    }
                ],
                [
                    ...
                    'buttons' => [
                        'delete' => function($url,$model,$key){
                            $html = '';
                            $html .= Html::hiddenInput('MaterialOutboundInfo[outboundInfoId][]',$model->id);
                            $html .= Html::hiddenInput('MaterialOutboundInfo[material_stock_info_id][]',$model->material_stock_info_id,['class' => 'stock_info_id']);
                            $html .= Html::hiddenInput('MaterialOutboundInfo[deleted][]').Html::img(Yii::$app->request->baseUrl.'/public/img/common/delete.png');
                            return $html;
                        }
                    ]
                ],
    ...
    <div class="form-group">
        <?= Html::a('取消',['@materialIndexOutboundIndex'],['class' => 'btn btn-cancel btn-form second-cancel']) ?>
