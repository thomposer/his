...
/* @var $searchModel app\modules\material\models\search\MaterialStockInfoSearch */
...
$params = [
    'searchName' => 'MaterialStockInfoSearch',
    'statusName' => 'status',
    'buttons' => [
        [
            'title' => '全部',
...
<div class="material-stock-info-index col-xs-10">
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($searchModel) use($numArr) {
                        return $numArr[$searchModel['material_id']]['total'];
                    },
                    'group' => true,
                    'subGroupOf'=>0
                ],
