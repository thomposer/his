            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($searchModel){
                        return MaterialOutbound::$getOutboundType[$searchModel->outbound_type];
                    }
                ],
                'department_name',
                [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($searchModel){
                            return Html::tag('span',MaterialStock::$getStatus[$searchModel->status]);
                    }
                ],
                [
                    'class' => 'app\common\component\ActionTextColumn',
                    'template' => '{material-outbound-update}{material-outbound-delete}{material-outbound-apply}{material-outbound-view}',
