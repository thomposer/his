    ...
    <div class="stock-form col-xs-10">
        <div class = "box">
            <div class="box-header with-border">
                ...
                <?=  Html::a(Html::img($baseUrl.'/public/img/common/icon_back.png').'返回',['@materialIndexOutboundIndex'],['class' => 'right-cancel']) ?>
            </div>
            <div class = "box-body">
                <div class="stock-apply col-md-12">
                    ...
                    <?php if($model->status == 2): ?>
                        <div class="form-group">
                            <?= Html::a('审核通过',['@materialIndexOutboundApply','id' => $id,'status' => 1],
                                [
                            ...
                            <?= Html::a('审核不通过',['@materialIndexOutboundApply','id' => $id,'status' => 3],
                                [
                                    'class' => 'btn btn-default btn-form',
                                    'data-method' => false,
                                    'aria-label' => '审核不通过',
