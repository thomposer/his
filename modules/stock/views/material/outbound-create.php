...
$this->title = '新增出库';
$this->params['breadcrumbs'][] = ['label' => '其他管理', 'url' => ['outbound-index']];
    ...
    <div class="stock-create col-xs-10">
        <div class = "box">
            <div class="box-header with-border">
                ...
                <?=  Html::a(Html::img($baseUrl.'/public/img/common/icon_back.png').'返回',['material-outbound-index'],['class' => 'right-cancel second-cancel']) ?>
            </div>
            <div class = "box-body">
