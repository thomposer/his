 ...
 */
class Outbound extends \app\common\base\BaseActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['spot_id','status', 'outbound_type', 'leading_department_id', 'leading_user_id', 'user_id', 'create_time', 'update_time'], 'integer'],
            [['remark'], 'string', 'max' => 255],
            [['outbound_time'],'date'],
            [['leading_department_id','leading_user_id'],'default','value' => 0]
        ];
    }
    ...
    {
        return $this->hasMany(OutboundInfo::className(), ['outbound_id' => 'id']);
    }
