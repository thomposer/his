 ...
 */
class MaterialOutbound extends \app\common\base\BaseActiveRecord
{
    ...
    {
        return $this->hasMany(MaterialOutboundInfo::className(), ['material_outbound_id' => 'id']);
    }
