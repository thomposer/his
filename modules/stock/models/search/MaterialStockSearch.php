...
/**
 * MaterialStockSearch represents the model behind the search form about `app\modules\material\models\MaterialStock`.
 */
class MaterialStockSearch extends MaterialStock
{
    public $name;
    /**
     * @inheritdoc
    ...
    public function searchDrugs($params, $pageSize = 20) {
        ...
        $query->select(['a.id','b.name', 'b.specification', 'b.manufactor', 'a.material_stock_id', 'a.total_num', 'c.inbound_time', 'a.invoice_number',  'userName'=>'e.username', 'c.status', 'supplier' => 'd.name']);
        ...
        $dataProvider = new ActiveDataProvider([
            ...
            'sort' => [
                'defaultOrder' => [
                    'material_stock_id'=>SORT_DESC,
                    'id' => SORT_ASC,
                ],
                'attributes' => ['id', 'status', 'inbound_time','material_stock_id']
            ]
        ]);
