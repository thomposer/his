 ...
 *
 * @property MaterialStockInfo[] $materialStockInfos
 */
class MaterialStock extends \app\common\base\BaseActiveRecord
{
    public $username;
    public $supplierName;
    public $begin_time;
     ...
     */
    public function getMaterialStockInfos()
    {
        return $this->hasMany(MaterialStockInfo::className(), ['material_stock_id' => 'id']);
    }
