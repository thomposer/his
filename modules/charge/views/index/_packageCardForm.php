...
<div class="package-card-tips-form">
    ...
    <?php foreach ($serviceIdArr as $key => $packageCardList): ?>
        <?php foreach ($packageCardList as $value): ?>
            <input type="hidden"class="form-control" name="PackageCardServiceId[<?= $key ?>][]" value="<?= $value ?>">
        <?php endforeach; ?>
    <?php endforeach; ?>
    <?php foreach ($serviceTime as $key => $value): ?>
