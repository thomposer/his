...
<div class="check-list-view col-xs-10">
    <div class = "box">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'value' => ConfigureClinicUnion::getClinicNameListString($model->id,ChargeInfo::$checkType)[$model->id]['spotName']
            ],
            [
                'attribute' => 'status',
                'value' => CheckList::$getStatus[$model->status],
            ],
