    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            [
                'attribute' => 'icon_url',
                'format' => 'raw',
                'value' => '<span class="logo-lg">'.Html::img($model->icon_url?Yii::$app->params['cdnHost'].$model->icon_url:$baseUrl.'/public/img/common/img_clinic_default.png',['onerror'=>"this.src='/public/img/common/img_clinic_default.png'"]).'</span>',
            ],
            'spot_name',
            [
                'attribute' => 'status',
