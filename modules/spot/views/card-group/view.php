...
<div class="card-recharge-category-view col-xs-12">
    ...
    <div class = "box">
        <div class="box-header with-border">
            ...
            <?= Html::a(Html::img($baseUrl . '/public/img/common/icon_back.png') . '返回', Url::to(['@spotCardManageGroupIndex']), ['class' => 'right-cancel', 'data-pjax' => 0]) ?>
        </div>
        <div class = "box-body card-recharge-category-view-content">  
            <div class="row">
                ...
                <?php if (isset($this->params['permList']['role']) || in_array(Yii::getAlias('@spotCardManageGroupUpdate'), $this->params['permList'])): ?>
                    <span class="card-manage-group-view-edit basic-family-right-up">
                        <a class="card-view-btn" role="modal-remote" data-modal-size="large" href="<?= $baseUrl ?>/spot/card-manage/group-update.html?id=<?= $model->f_physical_id ?>" >
