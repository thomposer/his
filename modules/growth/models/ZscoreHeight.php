...
/**
 * This is the model class for table "{{%growth_curve_zscore_height}}".
 *
 * @property integer $id
 ...
 */
class ZscoreHeight extends \app\common\base\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%growth_curve_zscore_height}}';
    }
