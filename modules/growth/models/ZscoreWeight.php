...
/**
 * This is the model class for table "{{%growth_curve_zscore_weight}}".
 *
 * @property integer $id
 ...
 */
class ZscoreWeight extends \app\common\base\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%growth_curve_zscore_weight}}';
    }
