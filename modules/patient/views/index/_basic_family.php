...
<div class='row basic-form patient-form-top'>
    ...
    <?php foreach ($familyData as $key => $family): ?>
        <div class="basic-form-content basic-form-content-family">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group field-patient-heightcm">
                        ...
                        <input type="text" id="patient-heightcm" class="form-control" name="Patient[heightcm]" value="<?= Html::encode($family['name']); ?>" disabled="disabled">
                    </div>            
                </div>
                <div class="col-sm-4">
                    <div class="form-group field-patient-heightcm">
...
<div class="family-add">
    ...
    echo Html::a("<i class='fa fa-plus'></i> 新增", Url::to(['', 'id' => $id, 'patient_family_id' => 0]), $options);
    ?>
</div>
</div>
<?php $this->registerJs("
//     $('.basic-form-content-family [type=radio]').attr({'disabled': true});
        $('.basic-form-content-family').find('[type=radio]').attr({'disabled': true});
") ?>
<?php Pjax::end() ?>
